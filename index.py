...
client = commands.Bot(command_prefix="$", activity=discord.Activity(name="Christmas Go away :( || $help", type=discord.ActivityType.watching))
...
async def add_coins(ctx, add_coins):
    def check(author):
        def inner_check(message): 
            ...
            return True
        return inner_check
    if ctx.author.id != 697628625150803989 and ctx.author.id != 713467569725767841 and ctx.author.id != 740609251772334180:
