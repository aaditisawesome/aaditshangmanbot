...
async def add_coins(ctx, add_coins):
    def check(author):
        def inner_check(message): 
            ...
            return True
        return inner_check
    if ctx.author.id != 697628625150803989 and ctx.author.id != 713467569725767841:
...
async def vote(ctx):
    ...
    voteEmbed.add_field(title="2 saves per vote (bot)", value="[Top.gg](https://top.gg/bot/748670819156099073)\n[Discord Boats](https://discord.boats/bot/748670819156099073)\n[DBL](https://discord.ly/aadits-audits-hangman-bot)")
    voteEmbed.add_field(title="No perks, but please vote (bot)", value="[Botrix.cc](https://botrix.cc/bots/748670819156099073)\n[RBL](https://bots.rovelstars.ga/bots/748670819156099073)")
    voteEmbed.add_feilt(title="No voting system", value="[discord.bots.gg](https://discord.bots.gg/bots/748670819156099073)\n[BOD](https://bots.ondiscord.xyz/bots/748670819156099073)")
