...
class UserSettingsDropdown(discord.ui.Select):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        if view.chosen == "tips" or view.chosen == "hangman_buttons" or view.chosen == "ticTacToe" or view.chosen == "vote_reminders":
...
class UserSettings(discord.ui.View):
    def __init__(self, user, tttenabled: bool, currentSettings, original_interaction: discord.Interaction):
        ...
        options = [
            ...
            discord.SelectOption(label="Vote Reminders", value = "vote_reminders", description="Select to configure your setting for vote reminders!"),
